#!/usr/bin/env python3
"""Self-play one game with fix_v5 model, render as GIF (1s/frame)."""
...
def main():
    ...
    traj, avg_len, bw, ww, dr = run_selfplay(model, DEVICE, G=1, M=8, S=256, c_puct=0.2)
    ...
    out = f'gomoku_fix_v5_step{step}.gif'
