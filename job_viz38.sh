...
#SBATCH --job-name=viz38
#SBATCH --output=slurm_logs/slurm_viz38_%j.out
set -euo pipefail
...
echo "=== Self-play GIF: step_38 ==="
mkdir -p output
python -u scripts/selfplay_viz.py \
    checkpoints/run200/step_000038.pt \
    output/selfplay_step38.gif
