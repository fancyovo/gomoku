...
| 61 | 05/25 | **5-step from-scratch (scratch5)**: G=512, M=8, S=64. Initial pool from gen_data.py | step_0=1236, step_4=1795, ΔELO=+559 |
| 62 | 05/25 | **15-step from-scratch (scratch15)**: Same setup, 15 steps. step_0=1055 (below noisy_uniform 1116), step_11=1741 peak, ΔELO=+626 | test_p flat at 0.984, test_v drops 0.999→0.978 |
...
- **Best models**: scratch5/step_000004.pt (ELO 1795), scratch15/step_000011.pt (ELO 1741)
- **From-scratch works**: No pretraining needed — step_0 starts near noisy_uniform and climbs
- **Key open problem**: Policy head test_p flat at ~0.984 across all steps; value head improvement drives ELO gains
