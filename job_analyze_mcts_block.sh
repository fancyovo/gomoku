...
#SBATCH --job-name=analyze_block
#SBATCH --output=slurm_logs/slurm_analyze_block_%j.out
set -euo pipefail
...
echo "=== Running blocking analysis (S up to 4096) ==="
python -u scripts/analyze_mcts_block.py \
