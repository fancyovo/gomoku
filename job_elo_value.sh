...
#SBATCH --job-name=elo_value
#SBATCH --output=slurm_logs/slurm_elo_value_%j.out
set -euo pipefail
...
echo "=== Value-only ELO: run20_lr1e4 (uniform policy + MCTS) ==="
python -u scripts/eval_elo_value.py \
